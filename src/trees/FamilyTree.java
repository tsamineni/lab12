...
public class FamilyTree
{
    ...
    private static class TreeNode
    {
        ...
        TreeNode getNodeWithName(String targetName)
        {
            ...
            {
            	System.out.println("Node being checked: " + child.getName());
	...
	private void addLine(String line) throws TreeException
	{
		...
		if (colonIndex < 0)
			throw new TreeException("colon index negative"); 	// throw a TreeException with a useful message
		...
		System.out.println("Parent is: " + parent);		           										//class java.util.String, method substring(), if you need guidance.
		...
		else
		{
			...
			if (parentNode == null)
				throw new TreeException("node structure error");
	...
	TreeNode getMostRecentCommonAncestor(String name1, String name2) throws TreeException
	{
		...
		if (node1 == null)
			throw new TreeException(name1 + " not found in family tree"); //Throw a TreeException with a useful message
		TreeNode node2 = root.getNodeWithName(name2);		// node whose name is name2
		if (node2 == null)
			throw new TreeException(name2 + " not found in family tree"); //Throw TreeException with a useful message
...
//		for (TreeNode ancestor : ancestorsOf2) {
//			System.out.print("[");
//			System.out.print(ancestor.getName() + " ");
//			System.out.print("]");
